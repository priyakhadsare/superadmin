      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <Card className="bg-white">
          ...
          <CardContent className="space-y-4 text-left">
            ...
            <div className="grid gap-2">
              <Label>HRA (%)</Label>
              <Input type="number" defaultValue="20" className="bg-white" />
            </div>
            <div className="grid gap-2">
            ...
            <div className="grid gap-2">
              ...
              <Input type="number" defaultValue="0" className="bg-white" />
            </div>
            <div className="grid gap-2">
        ...
        <Card className="bg-white">
          ...
          <CardContent className="space-y-4 text-left">
            <div className="grid gap-2">
              ...
              <Input type="number" defaultValue="12" className="bg-white" />
            </div>
            <div className="grid gap-2">
              <Label>ESIC (%)</Label>
              <Input type="number" defaultValue="0.75" className="bg-white" />
            </div>
            <div className="grid gap-2">
              <Label>Professional Tax (Fixed)</Label>
              <Input type="number" defaultValue="200" className="bg-white" />
            </div>
            <div className="grid gap-2">
              <Label>TDS (%)</Label>
