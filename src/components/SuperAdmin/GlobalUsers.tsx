  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-900 dark:text-slate-100 flex items-center gap-2 text-left">
      ...
      <div className="flex flex-col md:flex-row gap-4 items-center">
        <div className="relative flex-1">
          ...
          <Input 
            ...
            className="pl-9 h-11 border-slate-200 focus-visible:ring-orange-500"
          />
        </div>
      ...
      <Card className="border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden bg-white">
                    ...
                    <div className="flex justify-end items-center gap-1">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-48 bg-white">
                          <DropdownMenuItem className="gap-2 focus:bg-orange-50 transition-colors cursor-pointer">
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-200 flex justify-center">
          <Button variant="ghost" size="sm" className="font-bold text-orange-600 hover:bg-orange-50 h-8">
            Load More Users
          </Button>
        </div>
      </Card>
